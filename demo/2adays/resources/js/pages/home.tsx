    ...
    return (
        <div className="absolute inset-0 opacity-20">
            ...
            <div className="absolute inset-0">
                <div className="absolute top-1/4 right-0 left-0 h-0.5 bg-white opacity-30"></div>
                <div className="absolute top-2/4 right-0 left-0 h-0.5 bg-white opacity-40"></div>
                <div className="absolute top-3/4 right-0 left-0 h-0.5 bg-white opacity-30"></div>
                <div className="absolute top-0 bottom-0 left-1/4 w-0.5 bg-white opacity-30"></div>
                <div className="absolute top-0 bottom-0 left-2/4 w-0.5 bg-white opacity-40"></div>
                <div className="absolute top-0 bottom-0 left-3/4 w-0.5 bg-white opacity-30"></div>
                <div className="absolute top-0 bottom-0 left-3/4 w-0.5 bg-white opacity-30"></div>
            </div>
            <div className="absolute top-16 left-12 rotate-12 transform">
                <div className="flex items-center rounded-lg bg-white/80 px-3 py-2 shadow-lg">
                    <div className="mr-2 flex text-lg text-yellow-400">
                        <svg
            ...
            <div className="absolute top-32 right-20 -rotate-12 transform">
                <div className="flex items-center rounded-lg bg-white/80 px-3 py-2 shadow-lg">
                    <div className="mr-2 flex text-lg text-yellow-400">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="text-sm font-semibold text-gray-700">Rated</span>
                </div>
            </div>
            <div className="absolute bottom-24 left-16 rotate-6 transform">
                <div className="flex items-center rounded-lg bg-white/80 px-4 py-3 shadow-lg">
                    <div className="mr-3 flex text-xl text-yellow-400">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                            ...
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            className="lucide lucide-star h-5 w-5 fill-current"
                        >
                            <path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"></path>
                        </svg>
                        <svg
                    ...
                    <span className="text-base font-bold text-gray-700">Top Rated</span>
                </div>
            </div>
            <div className="absolute right-12 bottom-32 -rotate-6 transform">
                <div className="flex items-center rounded-lg bg-white/80 px-3 py-2 shadow-lg">
                    <div className="mr-2 flex text-lg text-yellow-400">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="absolute top-20 right-32 rotate-45 transform text-6xl text-blue-200 opacity-40">⚽</div>
            <div className="absolute bottom-40 left-32 -rotate-12 transform text-5xl text-blue-200 opacity-40">🏀</div>
            <div className="absolute top-40 left-1/3 rotate-12 transform text-4xl text-blue-200 opacity-40">🏈</div>
            <div className="absolute right-1/3 bottom-20 rotate-6 transform text-5xl text-blue-200 opacity-40">⚾</div>
        </div>
    );
}
